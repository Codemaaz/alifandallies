...
const Contact = () => {
  return (
    <div className="flex justify-center">
      <div className="relative w-4/5 z-10 overflow-hidden bg-white py-20 dark:bg-dark lg:py-[120px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <MdLocationOn className=" inline text-secondary mx-2 text-3xl " />
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-primary sm:h-[70px] sm:max-w-[70px]">
                  <MdPhone className=" inline text-secondary mx-2 text-3xl" />
                  </div>
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-dark dark:text-white">
                      Phone Number
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <MdOutlineEmail className="inline text-secondary mx-2 text-3xl" />
                  </div>
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold text-dark dark:text-white">
                      Email Address
